              ...
              child: Column(
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      border: OutlineInputBorder(),
                      prefixIcon: Icon(Icons.emoji_people, color: Colors.indigo,),
                      hintText: 'Estado'
                    ),
                  ),
                  SizedBox(height: 20,),
                  DropdownButtonFormField<String>(
                    ...
                    validator: (value) => value == null ? 'Complete el tipo de usuario' : null, 
                    ...
                    onPressed: () async {
                      if (_formkey.currentState!.validate()) {
                        await authService.registrarEmailPassword(emailcon.text.toString(), passwordcon.text.toString()).then((value) {
                          ...
                          addUsuario(usuario(nombrescon.text, apellidoscon.text, dnicon.text, estadocon.text, estado.toString(), emailcon.text, '')).then((value) => {toastmessage('Datos guardados correctamente')});
