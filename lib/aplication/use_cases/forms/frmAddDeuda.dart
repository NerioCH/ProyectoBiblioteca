...
import 'package:bibliotecaApp/domain/entities/Deuda.dart';
import 'package:bibliotecaApp/infraestructure/controllers/cDeuda.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import 'package:shared_preferences/shared_preferences.dart';

class frmAddDeuda extends StatefulWidget {
  const frmAddDeuda({super.key});

  @override
  State<frmAddDeuda> createState() => _frmAddDeudaState();
}

class _frmAddDeudaState extends State<frmAddDeuda> {
              ...
              ElevatedButton(
                onPressed: () {
                  if (_formkey.currentState!.validate()) {
                    guardarDeuda(deuda(email??'', titulo.text, detalles.text, fechaLimite.text, double.parse(monto.text))).then((value) => {
